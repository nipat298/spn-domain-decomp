...
% function to compute the elemental coeffecient matrices for the SPN approximation. 
% Presently only works for the SP3 approximation. Support can be extended to higher/ lower orders in future versions. 
% (Not tested for n=1,5,7)

%%%%%%%%%%%% INPUT %%%%%%%%%%%%%%%%%
% N - order of the approximation
% Nelem - # of elements
% mesh - structure variable containing meshing information
% mua - elementwise total absorption coeffecient. for freq domain case, this includes the freq. dependednt term as well.
...
%%%%%%%%% OUTPUT %%%%%%%%%%%%%%%%%
% Cgradphi,Cphi,Cgradbphi,Cbphi, CJ - see ref. 1 for definitions and details

%%%%%%%%% REFERENCES %%%%%%%%%%%
% 1. Fully non-linear Sp3 approximation based FOT - Nishigandha
% 2. Klose 2005
%%
