...
h=[0.5,0.5]; %Mesh spacing for structured mesh. Recommended to use same mesh size in each dimension, 
...
Source(1).mfreq = 500; % Modulation frequency
...
Source(1).Loc=[0,0]; % source location
