function [Ks,Km,Kb,Iv,Jv,V]=Assemble_on_fly(mesh)
%Generate assembly matrices for Elemental Basis
% 7 December 2020 - corrected scale factor in K_S
...
x1=gpuArray(P(T(:,1),1)); y1=gpuArray(P(T(:,1),2)); z1=gpuArray(P(T(:,1),3));
x2=gpuArray(P(T(:,2),1)); y2=gpuArray(P(T(:,2),2)); z2=gpuArray(P(T(:,2),3));
x3=gpuArray(P(T(:,3),1)); y3=gpuArray(P(T(:,3),2)); z3=gpuArray(P(T(:,3),3));
x4=gpuArray(P(T(:,4),1)); y4=gpuArray(P(T(:,4),2)); z4=gpuArray(P(T(:,4),3));
...
clear b1 b2 b3 b4 c1 c2 c3 c4 d1 d2 d3 d4
