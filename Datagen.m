function [mesh,Md,varargout]=Datagen(simulation,SettingsFile,func,snr,fcs_flag,norm_flag)
%% Data generator
...
if ~fcs_flag
    %basic spn
    [Jd]=func(Dimension,N,SimType,mesh,Src,Det,AssemblyFile,pfuncflag,evalFluence,probType);
else
    % fcs/ de variants
    [phi_u,Jd]=func(Dimension,N,SimType,mesh,Src,Det,AssemblyFile,pfuncflag,evalFluence,probType);
    varargout{1}=phi_u;
end
...
% Plot_mu2(mesh.nodes,mesh.tri,h(1),mesh.opt.muaxf,1,0.25);